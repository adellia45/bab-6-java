...
//        String temp = JOptionPane.showInputDialog(null, "Masukkan Angka", "Menentukan Ganjil Genap", JOptionPane.QUESTION_MESSAGE);
...
//      JOptionPane.showMessageDialog(null,"Dewasa");}
  ...
  switch (nilai.toUpperCase()){
      ...
      case "D":
          ...
          break;
      default :
           JOptionPane.showMessageDialog(null,"Salah memasukkan nilai !");
  }
  }
